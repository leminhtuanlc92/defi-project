...
export default () => {
    ...
    const getNode = async (_startUser) => {
        ...
        setNodeData({
            ...
            F1: result.F1.map(item => (window as any).tronWeb.address.fromHex(result.parent)),
            level,
            name: name.username,
        });
    };
        ...
        <ChartNodesWrap>
            {nodeData === null ?
                ...
                <div id="cni">
                    ...
                    <div id="cni_F1">
                        <NodeItemWrap node="f1"
                            status={nodeData.F1[0] === nodeData.parent ? 'empty' : 'active'}
                            data={nodeData.F1[0]}
                        />
                        <NodeItemWrap node="f1"
                            status={nodeData.F1[1] === nodeData.parent ? 'empty' : 'active'}
                            data={nodeData.F1[1]} />
                        <NodeItemWrap node="f1"
                            status={nodeData.F1[2] === nodeData.parent ? 'empty' : 'active'}
                            data={nodeData.F1[2]}
                        />
                    </div>
                    <div id="cni_note">
