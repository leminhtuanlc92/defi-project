...
export default ({ contract }) => {
  ...
  useEffect(() => {
    if (contract?.getRefBalance) {
      contract
        .getRefBalance(address)
        .call()
        .then((info) => {
          setRefData([
            { title: "F1", value: info[0] / 10 ** 6 },
            { title: "F2", value: info[1] / 10 ** 6 },
            { title: "F3", value: info[2] / 10 ** 6 },
            { title: "F4", value: info[3] / 10 ** 6 },
            { title: "F5", value: info[4] / 10 ** 6 },
            { title: "F6", value: info[5] / 10 ** 6 },
            { title: "F7", value: info[6] / 10 ** 6 },
            { title: "F8", value: info[7] / 10 ** 6 },
          ]);
        });
    }
  }, [contract]);
    ...
    <RefBalanceWrap>
      ...
      <div className="rb_inner">
        {refData.map((item, index) => {
          return <RefItem key={index} title={item.title} value={item.value} />;
        })}
        <div className="clear" />
      </div>
    </RefBalanceWrap>
