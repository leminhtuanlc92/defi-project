                ...
                <div className="mb_input">
                    <div className="mbi_inner">
                        ...
                        <div className="left_input">
                            ...
                            />
                            <div className={`mbi_interest ${amountStake < 10000 ? 'unavailable' : ''}`} title={i18n.t('interest')}>
                                <img src={interestImg} alt="" />
                                <span>
                                    {
                                        amountStake + stats[0].value >= 500000 ? '12%' :
                                            amountStake + stats[0].value >= 100000 ? '10%' :
                                                amountStake >= 10000 ? '8%' : '0%'
                                    }
                                </span>
                            </div>
                            <div className="mbi_error">
                                {errorInput === 'minimumAmount10k' || errorInput === 'invalidInput' ?
