            ...
            <div id="partner_mainbody">
                <div id="pm_filter">
                    ...
                    <div id="pmf_1">
                        <div id="pmf1_left">
                            <div className="pmf1l_block">
                                ...
                                <input onChange={(e) => setStartUser(e.target.value)} placeholder={i18n.t('username')} />
                            </div>
                            <div className="pmf1l_block">
                                <span className="pmf_label">{i18n.t('inputSearchLevel')}:</span>
                                <input onChange={(e) => setLevel(e.target.value)} placeholder={i18n.t('level')} />
                            </div>
                        </div>
                        <div id="pmf1_right">
                    ...
                    <div id="pmf_2">
                        <div id="pmf2_left">
                            <div id="pmf2l_block">
                                <span className="pmf_label">{i18n.t('inputStartUser')}/{i18n.t('searchAddress')} :</span>
                                <input onChange={(e) => setStartUser(e.target.value)}
                ...
                <div id="pm_filter_result">
                    <PartnerSearchList startUser={startUser} level={level} searchUser={searchUser}/>
                    <div id="pmfr_pagination_wrap">
                        <Pagination currentPage={2} totalPage={12} size={5} url="/partners" />
                    </div>
                </div>
            </div>
        </PartnerskWrap >
