                        ...
                        <div id="bpc_inner">
                            ...
                            <div id="bpc_main">
                                ...
                                <div className="bpcms_quotes">
                                    <span>{i18n.t('buySuccessQuote')} X token {i18n.t('inRound')} Co-founder {i18n.t('withPrice')}</span>
                                    <span>{i18n.t('backToHomePageContinue')}</span>
                                </div>
                                <button id="bpcms_button" onClick={() => {
                                    setShowPop(false)
                                    history.push('/')
                                }}>{i18n.t('backToDashboard')}</button>
                            </div>
                        </div>
                        :
                        <div id="bpc_inner">
                            ...
                            <div id="bpc_main">
                                <div id="bpcm_quantity">
                                    <span className="bpcm_label">{i18n.t('quantityAvailable')}:</span>
                                    <div className="bpcm_input">
                                        <input onChange={(e) => setCanBuy(+e.target.value)} />
                                        <span>{i18n.t('token')}</span>
                                    </div>
                                </div>
                                <div id="bpcm_amount">
                                    <span className="bpcm_label">{i18n.t('usdtDesiteToBuy')}:</span>
                                    <div className="bpcm_spec_wrap">
                                        <div className="bpcm_input">
                                            <input onChange={(e) => setUsdtTobuy(+e.target.value)} />
                                            <span>{i18n.t('usdt')}</span>
                                        </div>
                                        <span className="bpcmsw_convert">{i18n.t('with')} 1$ = 0.1 {i18n.t('token')}</span>
                                    </div>
                                </div>
                                <div id="bpcm_token_receive">
                                    <span className="bpcm_label">{i18n.t('quantityAvailable')}:</span>
                                    <div className="bpcm_input">
                                        <input onChange={(e) => setEstimate(+e.target.value)} />
                                        <span>{i18n.t('token')}</span>
                                    </div>
                                </div>
                                <div id="bpcm_action">
                                    <button id="bpcma_cancel" onClick={()=>setShowPop(false)}>{i18n.t('cancel')}</button>
                                    <button id="bpcma_buy" onClick={() => setSuccess(true)}>{i18n.t('buy')}</button>
                                </div>
                            </div>
                        </div>
                    }
                    <div id="bpc_close_button" onClick={() => { setShowPop(!showPop) }}>
    ...
    #buy_pop_content{
        ...
        #bpc_inner{
            ...
            #bpc_main{
                ...
                #bpcm_quantity, #bpcm_amount, #bpcm_token_receive{
                    flex-direction:column;
                    width:55%;
                    margin-bottom:30px;
                }
